...
👉 **[Mở Trình Chỉnh Sửa Markdown](https://sspig0127.github.io/md-studio/)**
...
md-studio sử dụng **Google OAuth 2.0** và Drive API với luồng dữ liệu này:

```
Trình Duyệt Của Bạn  ←────────────────────→  Máy Chủ Google
                       Kết Nối HTTPS Trực Tiếp

Các nhà phát triển md-studio không thể nhìn thấy bất kỳ dữ liệu người dùng nào
```

| Mục | Mô Tả |
|-----|--------|
| **Client ID là gì** | Một mã định danh cho "md-studio ứng dụng", không chứa thông tin tài khoản cá nhân, an toàn để chia sẻ công khai |
...
Nhấp vào "Đám Mây → Đăng Nhập Bằng Google"
  ...
  → Nhập tài khoản Google của bạn (không đi qua md-studio)
...
> **Lên Kế Hoạch**: Phiên bản GitHub Pages chính thức (`sspig0127.github.io/md-studio`) sẽ bao gồm một Client ID được chia sẻ,
...
7. Trong md-studio, nhấp vào ⚙ → dán Client ID → Lưu → làm mới trang
