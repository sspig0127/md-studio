...
## 🎓 新手導覽 Onboarding Tour ✅ 已完成（2026-03-15）
...
#### ✅ 手機版補充「大綱面板」步驟 ✅ 已完成（2026-03-15）

手機導覽（7 步）已新增大綱面板步驟：

| 步驟 | 目標元素 | 說明重點 |
|------|---------|---------|
| 6 | `.status-bar` + `pulseTarget: '#btn-outline'` | 說明右下角大綱按鈕，脈衝動畫指向 `#btn-outline` |
| 7 | `#btn-mobile-menu` | 介紹 ☰ Drawer 選單 |

**實作**：`MOBILE_STEPS` 已包含 `pulseTarget: '#btn-outline'`，行為與桌機版一致。
...
*最後更新：2026-03-15（確認手機版 Tour 大綱面板步驟已完成，共 7 步）*
